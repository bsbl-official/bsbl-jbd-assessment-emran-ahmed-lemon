...
public class EnrollmentController {
    ...
    public ResponseEntity<ApiResponse<List<EnrollmentResponse>>> findAll() {
        ...
        return ResponseEntity.ok(
                ApiResponse.success("Enrollments retrieved successfully", response)
        );
    }
    ...
    public ResponseEntity<ApiResponse<List<EnrollmentResponse>>> findByStudentId(
        ...
        return ResponseEntity.ok(
                ApiResponse.success("Student courses retrieved successfully", response)
        );
    }
}